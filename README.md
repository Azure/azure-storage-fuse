...
##  NOTICE
- Do not use versions 2.2.0, 2.2.1 and 2.3.0 for performing random writes using Block-cache mode. We have idenitified potential data integrity issues that are being investigated and fixed.
