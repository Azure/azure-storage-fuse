...
- When Blobfuse2 is mounted on a container/AKS, SYS_ADMIN privileges are required for it to interact with the fuse driver. If container is created without the privilage, mount will fail. Sample command to spawn a docker container is 
