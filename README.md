...
Blobfuse2 now supports OpenTelemetry for sending structured logs and metrics to Azure Monitor, Application Insights, or any OpenTelemetry-compatible backend. This enables enhanced observability with rich log attributes and integration with modern monitoring platforms. See [OTEL_SETUP.md](OTEL_SETUP.md) for detailed setup instructions.
