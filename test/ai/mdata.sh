...
python3 saveData.py --data_path "HuggingFaceTB/cosmopedia" --subset "web_samples_v1" >> stats.log

./data.sh "hugging" "nvidia/OpenMathReasoning"
python3 saveData.py --data_path "nvidia/OpenMathReasoning" --subset "default" >> stats.log

models=("cosmopedia" "nvidia/OpenMathReasoning")
for model_name in "${models[@]}"; do
	./data.sh "file-cache" "cosmopedia" >> stats.log
	python3 saveData.py --data_path "/mnt/blobfuse/mnt" --subset "default" >> stats.log
	echo "--------------------------------------------------------------------" >> stats.log
