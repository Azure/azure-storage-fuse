...
func TestFileTruncateShrink(t *testing.T) {
	...
	tests := []struct {
		...
		{fmt.Sprintf("%s20M_5K_truncate", filename), 20 * 1024 * 1024, 5 * 1024, truncate},
		...
		{fmt.Sprintf("%s20M_5K_ftruncate", filename), 20 * 1024 * 1024, 5 * 1024, ftruncate},
...
func TestFileTruncateExpand(t *testing.T) {
	...
	tests := []struct {
		...
		{fmt.Sprintf("%s5K_20M_ftruncate", filename), 5 * 1024, 20 * 1024 * 1024, ftruncate},
