...
- Added `Client Assertion` based authentication for containers. Configure `tenant-id, client-id, client-assertion and user-assertion` with `authMode` set to `behalf`.
